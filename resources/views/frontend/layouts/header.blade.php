    ...
    <div class="container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li><a href="services.html">Hasta Köşesi</a></li>
                <li class="drop-down"><a href="">Çalışmalar</a>
                    <ul>
                        <li><a href="about.html">Makaleler</a></li>
                        <li><a href="team.html">Bilimsel Yayınlar</a></li>
                        <li><a href="testimonials.html">Olgular</a></li>
                        <li class="drop-down"><a href="#">Deep Drop Down</a>
                            <ul>
                                <li><a href="#">Deep Drop Down 1</a></li>
                                <li><a href="#">Deep Drop Down 2</a></li>
